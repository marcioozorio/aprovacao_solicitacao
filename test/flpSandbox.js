		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ação Urgente",
									"targetURL": "#aprovacaosolicitacao-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aprovacaosolicitacao-display": {
								"semanticObject": "aprovacaosolicitacao",
								"action": "display",
								"description": "Ação Urgente",
								"title": "Ação Urgente",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aprovacaosolicitacao",
									"url": sap.ui.require.toUrl("aprovacaosolicitacao")
								}
							}
						}
					}
